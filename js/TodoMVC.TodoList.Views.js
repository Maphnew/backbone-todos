TodoMVC.module('TodoList.Views', function(Views, App, Backbone, Marionette, $, _) {
    ...
    // Item List View
    // --------------
    // Control the rendering of the list of items, including the filtering of active vs completed items for display
    ...
    // vent는 TodoList 컨트롤러에서 filterItem 트리거를 처리할 수 있도록 해주는 이벤트 수집기다.
